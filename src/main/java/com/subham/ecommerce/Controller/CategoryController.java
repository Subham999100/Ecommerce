...
public class CategoryController {
    ...
    public ResponseEntity<String> CreateCategories(@RequestBody Category category){
         ...
         return new ResponseEntity<>("Category Created Succesfully",HttpStatus.CREATED);
    }
    @DeleteMapping("/api/admin/categories/{categoryId}")
    public ResponseEntity<String> deletCategory(@PathVariable Long categoryId){
        try {
            String status=categoryService.deletCategory(categoryId);
